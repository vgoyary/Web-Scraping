...
# #
# # def fetch_products(category_name, category_slug):
...
# #             "image": product.get("thumbnail_image", "N/A"),
# #             "barcode": barcode,
# #             "weight": product.get("weight", "N/A"),
# #             "description": product.get("short_description", "N/A"),
# #             "delivery_methods": product.get("delivery_methods", "N/A"),
...
# #         category_products = fetch_products(category_name, category_slug)
...
#
#     try:
#         description = driver.find_element(By.CSS_SELECTOR, "div.product-description").text.strip()
#     except:
#         description = "N/A"
#
#     try:
#         weight = driver.find_element(By.XPATH,
#                                      "//span[contains(text(), 'Weight')]/following-sibling::span").text.strip()
#     except:
#         weight = "N/A"
#
#     try:
#         delivery_methods = driver.find_element(By.CSS_SELECTOR, "div.delivery-methods").text.strip()
#     except:
#         delivery_methods = "N/A"
#
#     return description, weight, delivery_methods
#
#
...
#         product_url = f'https://www.bigc.co.th/en/product/{product.get("slug", "")}'
#
#         # Extract missing details only if they are "N/A"
#         description, weight, delivery_methods = scrape_missing_details(product_url, driver)
#
#         all_products.append({
#             "name": product.get("name", "N/A"),
#             "price": product.get("final_price_incl_tax", "N/A"),
...
def scrape_missing_details(product_url, driver):
    ...
    try:
        price_per_unit = driver.find_element(By.CSS_SELECTOR,
                                             "#pdp_product-price-new .productDetail_product_price_new__TKGLM").text.strip()
    except:
        price_per_unit = "N/A"

    try:
        weight_info = driver.find_element(By.CSS_SELECTOR,
                                          "#pdp_product-sellInKg .productDetail_weight-description__zPT27").text.strip()
    except:
        weight_info = "N/A"
    ...
    delivery_methods = []
    try:
        delivery_sections = driver.find_elements(By.CSS_SELECTOR,
                                                 ".shipping_section_shipping__bOz4_ .shipping_shipping_item__bzHrT")
...
def fetch_products(category_name, category_slug, driver):
    ...
    for product in products_data:
        ...
        description, brand, category, price_per_unit, weight_info, delivery_methods = scrape_missing_details(
            product_url, driver)
